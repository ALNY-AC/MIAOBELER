...
class NominateController extends CommonController {
    ...
    public function get() {
        ...
        $model = M();
        $result = $model -> field('t1.*,t2.goods_id,t2.title,t2.price,t2.str_price,t2.head_img') -> table('mia_nominate as t1,mia_goods as t2') -> where('t1.goods_id = t2.goods_id') -> order('t1.sort asc') -> select();
