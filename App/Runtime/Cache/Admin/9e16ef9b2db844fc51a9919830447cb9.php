    ...
    <body>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <span class="input-group-addon" style="padding: 0;" id="basic-addon2">
                                    <img id="captchaB" style="cursor: pointer;" onclick="this.src='/MIAOBELER/index.php/Admin/Login/captcha/key/'+Math.random()" src="/MIAOBELER/index.php/Admin/Login/captcha" />
                                </span>
        ...
        <script type="text/javascript">
            $('.login').on('click', function() {
                ...
                $.post('/MIAOBELER/index.php/Admin/Login/login', {
                    'user_id': user_id,
                    'user_pwd': user_pwd,
                    'captcha': captcha,
                }, function(result) {
                    ...
                    if(result['result'] === 'error') {
                        ...
                        $('#captchaB').attr('src', '/MIAOBELER/index.php/Admin/Login/captcha/key/' + Math.random());
                    } else {
